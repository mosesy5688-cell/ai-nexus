...
self.onmessage = async (e) => {
    ...
    if (type === 'SEARCH') {
        ...
        // V14.2: REMOVED D1 FALLBACK per Zero-Cost Constitution
        // Search now uses ONLY static R2 data (trending.json)
...
// V14.2: D1 fallback function REMOVED per Zero-Cost Constitution
// All search is now purely static/client-side
