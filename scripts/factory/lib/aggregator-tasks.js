 ...
 */
export function buildTaskList(rankedEntities, outputDir) {
    return [
        ...
        { name: 'Search', id: 'search', fn: () => generateSearchIndices(rankedEntities, outputDir) },
        { name: 'CategoryStats', id: 'category', fn: () => generateCategoryStats(rankedEntities, outputDir) },
        {
            name: 'Relations', id: 'relations', fn: async () => {
                ...
                await computeAltRelations(rankedEntities, outputDir);
                await computeKnowledgeLinks(rankedEntities, outputDir);
