...
const DEFAULT_CRATES = 'shard-router,fni-calc,mesh-engine,content-extractor,stream-aggregator,satellite-tasks,r2-engine,markdown-renderer,ivf-pq,identity-cluster';
