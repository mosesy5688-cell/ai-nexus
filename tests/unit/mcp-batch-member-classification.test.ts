...
//      since a top-level array no longer reaches that predicate (isNotification
//      has exactly one call site, inside the single-message dispatcher, and
//      dispatchRpc intercepts an array before it). Measured: with the exclusion
