 ...
 * This route proxies the request to R2 for edge serving.
 */

import type { APIRoute } from 'astro';

const R2_PUBLIC_BASE = 'https://pub-a6ccc9ca36654f82a21e3f5466fa6ca7.r2.dev';

export const GET: APIRoute = async () => {
    try {
        // Try to fetch from R2
        const r2Url = `${R2_PUBLIC_BASE}/sitemaps/sitemap-index.xml`;
