...
function injectCount(phrase: string | null): string {
    ...
    return `Full-text search across the Free2AITools catalog of ${phrase} AI models, tools, datasets, papers, and benchmarks, ranked by FNI score. Returns up to 20 results per request.${PAGINATION_NOTE}${TRANSIENT_NOTE}`;
}
