document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderModels(page) {
        ...
        <a href="/model/${model.slug || model.id}" class="model-card group block bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700">
          <div class="p-5">
