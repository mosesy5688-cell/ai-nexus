...
/**
 * V16.7 Mesh Orchestrator
 * Centralizes node extraction, tiering, and deduplication to prevent UI overlaps.
 */
export async function getMeshProfile(locals, rootId, entity, type = 'model') {
    ...
    const tiers = {
        ...
        utility: { title: '🔬 Applied Research', nodes: [], icon: '🔬' },
    ...
    return { tiers, nodeRegistry, rawRelations, knowledgeIndex };
}
